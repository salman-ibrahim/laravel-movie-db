...
class ActorViewModel extends ViewModel
{
    ...
    public function actor(){
        ...
        ])->only('birthday','age','profile_path','name','homepage','place_of_birth','biography',);
    }
        ...
        return collect($castMovies)->sortByDesc('popularity')->take(5)
            ->map(function ($movie){
                ...
                return collect($movie)->merge([
                    ...
                    'title' => $title,
                    'link_to_page' => $movie['media_type'] === 'movie' ? route('movies.show',$movie['id']) : route('tv.show',$movie['id']),
                ])->only('id','title','poster_path','link_to_page');
            });
    ...
    public function credits(){
        ...
        return collect($castMovies)->map(function ($movie){
            ...
            return collect($movie)->merge([
                ...
                ])->only('release_year','character','title',);
