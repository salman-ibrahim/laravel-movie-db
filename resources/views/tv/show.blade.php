...
@section('content')
    ...
    <div class="tv-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-6 flex flex-col md:flex-row">
            <div class="flex-none p-2 border border-gray-700 rounded hover:bg-gray-700 transition
                ...
                <img src="{{ $tv['poster_path'] }}" alt="{{ $tv['name'] }}" class="w-72">
            </div>
            <div class="md:ml-24">
                <h2 class="text-4xl">{{ $tv['name'] }}</h2>
                ...
                <h4 class="text-white mt-5">Creator</h4>
                <div class="flex mt-4">
                                        ...
                                        <div class="modal-body p-8">
                                            <div class="responsive-container overflow-hidden overflow-x-hidden relative"
                                                ...
                                                <iframe class="responsive-iframe absolute top-0 left-0 w-full h-full"
                                                        src="{{ $tv['trailer'] }}" style="border:0;" allow="autoplay;
    ...
    <div class=""></div>
    <div class="tv-cast border-b border-grey-800">
